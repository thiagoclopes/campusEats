    ...
    return (
        <View className="w-fit px-6 mb-4">
            ...
            <View className="flex flex-col p-4 bg-white elevation-lg shadow-lg">
                ...
                <TouchableOpacity className={`mx-auto py-4 rounded-xl ${isButtonDisabled ? 'bg-black-gray opacity-70' : 'bg-red-main'}`} onPress={() => !isButtonDisabled && router.push(`/orderProgress?orderId=${order.id}`)} disabled={isButtonDisabled}>
